...
import { useGetBudgets } from "./data/get-budgets";
...
const MainScreen = () => {
  ...
  return (
    <div className="bg-white w-full h-screen flex flex-col">
      <Header />
      <Sidebar />
      <div className="px-4 md:ml-56 flex-grow">
        <div className="p-4 dark:border-gray-700 mt-14 md:mt-24 ">
          {/* Cabeçalho */}
          <div className="mb-4">
            ...
            <div className="">
              <div className=" h-10 rounded-lg border hidden md:flex border-black items-center dark:bg-gray-800">
              ...
              {data &&
                data.map((budget) => (
                  <div>
                    ...
                    <div><hr className="w-full border-t border-gray-300" /></div>
                  </div>
                ))}
            </div>
          </div>
